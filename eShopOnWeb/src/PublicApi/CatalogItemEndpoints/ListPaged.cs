...
namespace Microsoft.eShopWeb.PublicApi.CatalogItemEndpoints
{
        ...
        .WithResponse<ListPagedCatalogItemResponse>
    {
        ...
        public override async Task<ActionResult<ListPagedCatalogItemResponse>> HandleAsync(
            [FromQuery] ListPagedCatalogItemRequest request, CancellationToken cancellationToken)
        {
            ...
            _logger.LogInformation($"Returned {response.CatalogItems.Count} items");
